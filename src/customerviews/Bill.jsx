    ...
    function SaveBill(){
        ...
        axios.get("http://localhost:9669/bill/getbillid/").then((res)=>{
            ...
            sitems.map((item)=>{
                ...
                axios.post("http://localhost:9669/bill/billsave" , billobj)
                .then((res)=>{
                    alert(res.data)
                })
            });
        ...
        if(ispaymentdone==true){
            ...
            const options = {
                ...
                handler: async function(response){
                    ...
                    axios.post("http://localhost:9669/paymentdetails/paymentdetailsave" , paydetlobjdata)
                    .then((res)=>{
                        alert(res.data)
                ...
                </tr>
                {
                    props.data.selitems.map((item)=>(
                        <tr>
                            ...
                            <td>{item.pname}</td>
                            <td>{item.oprice}</td>
                            <img src={"http://localhost:9669/product/getproductimage/" + item.ppicname} alt=""  height={50} width={50}/>
                        </tr>
                    ))
                }
            </table>
